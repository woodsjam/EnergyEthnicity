...
summary(CopyKWH)
update(CopyKWH, .~ .-TOTSQFT_EN + PSQFT, data=RECSTemp)
...
```{r}
update(OrthodoxStructTenure)$fitted.values
all.vars(formula(OrthodoxKWH))
all.vars(formula(OrthodoxSQFT))
all.vars(formula(OrthodoxStructTenure))
