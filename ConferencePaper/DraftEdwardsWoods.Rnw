...
library(xtable)
#xtable(table(RECS$EthRace,RECS$TYPEHUQ), caption="Count of Observations by Race and Structure Type", label="tab:RaceVStruct")
@

<<echo=false,results=tex>>=
library(xtable)
#xtable(table(RECS$REGIONC,RECS$TYPEHUQ), caption="Count of Observations by Region and Structure Type", label="tab:RegionVStruct")
@
...
\begin{center}
<<echo=false,fig=TRUE>>=
#qplot(NHSLDMEM,data=RECS,facets =~EthRace, geom = "density",title="Household Size by Race and Ethnicity")+xlab("Household Size")
@
\end{center}
\end{figure}
...
<<echo=false, results=tex>>=
#xtable(table(RECS$EthRace,RECS$ESWWAC),caption="EnergyStar Wall AC by Race and Ethnicity", label="tab:EstarWall")
@


<<echo=false, results=tex>>=
#xtable(table(RECS$EthRace,RECS$UR),caption="Race by Urban/Rural", label="tab:UrbRural")
@


<<echo=false, results=tex>>=
#xtable(table(RECS$EthRace,RECS$FUELH2O),caption="Water Service by Race and Ethnicity", label="tab:Water")
@

<<echo=false, results=tex>>=
#xtable(table(RECS$EthRace,RECS$FUELHEAT),caption="Heating Fuel by Race and Ethnicity", label="tab:HeatFuel")
@

<<echo=false, results=tex>>=
#xtable(table(RECS$EthRace,RECS$Climate_Region_Pub),caption="Climate by Race and Ethnicity", label="tab:Climate")
@
...
<<echo=false,fig=TRUE>>=
#qplot(YEARMADE,data=RECS,facets =KOWNRENT~EthRace, geom = "density",)
@
\end{center}
\end{figure}
...
<<echo=false, results=tex>>=
#xtable(table(RECS$EthRace,RECS$NUMMEAL),caption="Weekly Meals Cooked by Race and Ethnicity", label="tab:Cooking")
@
...
<<echo=false,fig=TRUE>>=
#boxplot(TEMPHOME~EthRace, notch=TRUE,data=RECS)
@
\end{center}
\end{figure}
...
\label{fig:NightRace}
<<echo=false,fig=TRUE>>=
#boxplot(TEMPNITE~EthRace, notch=TRUE,data=RECS)
...
\label{fig:HomeRaceS}
<<echo=false,fig=TRUE>>=
#boxplot(TEMPHOMEAC~EthRace, notch=TRUE,data=RECS)
...
\label{fig:AwayRaceS}
<<echo=false,fig=TRUE>>=
#boxplot(TEMPGONEAC~EthRace, notch=TRUE,data=RECS)
...
<<echo=false,fig=TRUE>>=
#boxplot(TEMPNITEAC~EthRace, notch=TRUE,data=RECS)
@
\end{center}
\end{figure}
...
#print(xtable(LimitedKWH,caption="Orthodox kWh Model",label="tab:OrthoKWHLimited"),tabular.environment="longtable",label="tab:ParOrthKWH")
@
...
print(xtable(OrthodoxKWH,caption="Orthodox kWh Model",label="tab:OrthoKWHFull"),tabular.environment="longtable")
...
<<echo=false, results=tex>>=
print(xtable(OrthodoxSQFT,caption="Orthodox Square Foot Model",label="tab:OrthoSQFT"),tabular.environment="longtable",floating = FALSE)
@
