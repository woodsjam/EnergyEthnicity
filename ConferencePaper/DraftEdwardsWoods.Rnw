...
print(xtable(HUDCut,caption="HUD Complaints per 100,000 Population", label="tab:HUDComplaints"), include.rownames=FALSE,caption.placement="top",size="small",latex.environments="center",table.placement="htbp")
rm(HUD)
@
