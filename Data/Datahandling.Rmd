...
```{r}
recs2009_public <- read.csv("~/Research/EnergyEthnicity/Data/2009/recs2009_public.csv")

RECS05alldata <- read.csv("~/Research/EnergyEthnicity/Data/2005/RECS05alldata.csv")

```
Those two are simple but the 2001 data comes in many parts

```{r}
publicuse102001<-read.csv("~/Research/EnergyEthnicity/Data/2001/publicuse102001.csv", header=TRUE)  
publicuse2001<-read.csv("~/Research/EnergyEthnicity/Data/2001/publicuse2001.csv", header=TRUE)   
publicuse42001<-read.csv("~/Research/EnergyEthnicity/Data/2001/publicuse42001.csv", header=TRUE)  
publicuse72001<-read.csv("~/Research/EnergyEthnicity/Data/2001/publicuse72001.csv", header=TRUE)
publicuse112001<-read.csv("~/Research/EnergyEthnicity/Data/2001/publicuse112001.csv", header=TRUE)  
publicuse22001<-read.csv("~/Research/EnergyEthnicity/Data/2001/publicuse22001.csv", header=TRUE)  
publicuse52001<-read.csv("~/Research/EnergyEthnicity/Data/2001/publicuse52001.csv", header=TRUE)  
publicuse82001<-read.csv("~/Research/EnergyEthnicity/Data/2001/publicuse82001.csv", header=TRUE)
publicuse122001<-read.csv("~/Research/EnergyEthnicity/Data/2001/publicuse122001.csv", header=TRUE) 
publicuse32001<-read.csv("~/Research/EnergyEthnicity/Data/2001/publicuse32001.csv", header=TRUE)
publicuse62001<-read.csv("~/Research/EnergyEthnicity/Data/2001/publicuse62001.csv", header=TRUE)  
publicuse92001<-read.csv("~/Research/EnergyEthnicity/Data/2001/publicuse92001.csv", header=TRUE)
